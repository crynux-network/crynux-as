...
// NormalizeAssistantContent strips embedded tool-call blocks from assistant text and returns parsed tool calls.
// Thinking content outside tool-call blocks is preserved.
